"""
V2 werkt, alleen controleert hij nog niet op diagonalen. ook is de output nog
niet in een werkbare lijst.
"""
import re
...
def find_spec_chars(spec_strings):
    spec_char_pos = {}  # {1: [3,3]}
    search_pattern = re.compile(r"[^1-9.]")
